...
def official_brat_eval_mention(eval_tool_path, gold_path, prediction_path, exact_matching, label, official_stdout=False):
    ...
    cmd = ["java -cp "+ eval_tool_path +"brateval/target/brateval-0.3.0-SNAPSHOT.jar au.com.nicta.csp.brateval.CompareEntities "+ prediction_path +" "+ gold_path +" "+ exact_matching]
...
def official_brat_eval_relation(eval_tool_path, gold_path, prediction_path, exact_matching, label, hop_evaluation=False, verbose="false", official_stdout=False):
    ...
    if hop_evaluation:
        cmd = [
            "java -cp " + eval_tool_path + "brateval/target/brateval-0.3.0-SNAPSHOT.jar au.com.nicta.csp.brateval.CompareRelationsHop " + prediction_path + " " + gold_path + " " + exact_matching + " " + verbose]
    else:
        cmd = [
            "java -cp " + eval_tool_path + "brateval/target/brateval-0.3.0-SNAPSHOT.jar au.com.nicta.csp.brateval.CompareRelations " + prediction_path + " " + gold_path + " " + exact_matching + " " + verbose]
...
if __name__ == "__main__":
    ...
    gold_path = "/home/robert/FinalProject/RecipeRef/gold/"
    prediction_path = "/home/robert/FinalProject/RecipeRef/prediction/"
    exact_matching = "true"
    label = "Transformed"
